        ...
        <c:forEach var="book" items="${books}">
        	<div class="templatemo_product_box">
            	<h1>${book.title }  <span>(by ${book.author})</span></h1>
   	              <img src="${pageContext.servletContext.contextPath}/resources/images/${book.imageUrl}" alt="image" />
            ...
            <div class="templatemo_product_box">
   	      ...
   	      <img src="${pageContext.servletContext.contextPath}/resourcesimages/templatemo_image_03.jpg" alt="image" />
                <div class="product_info">
            ...
            <div class="cleaner_with_height">&nbsp;</div>
            -->
            <a href="subpage.html"><img src="${pageContext.servletContext.contextPath}/resources/images/templatemo_ads.jpg" alt="ads" /></a>
